  ...
  group('QuranComApiClient Integration Test', () {
    ...
    test(
      ...
      () async {
        ...
        logger.info(
          '✅ Audio URL: ${audioFile.audioUrl}',
          category: LogCategory.audio,
        );
        logger.info(
          '✅ Format: ${audioFile.format}, Size: ${audioFile.fileSize} KB',
          category: LogCategory.audio,
        );
        logger.info(
    ...
    test('should successfully fetch chapter audio without segments', () async {
      ...
      if (timestamps != null && timestamps.isNotEmpty) {
        logger.info(
          '  Timestamps successfully retrieved without segments array',
          category: LogCategory.audio,
        );
    ...
    test(
      ...
      () async {
        ...
        try {
          ...
          logger.info(
            '✅ Successfully caught expected error for invalid chapter:',
            category: LogCategory.audio,
          );
    ...
    test('should handle token caching and 401 recovery on real API', () async {
      ...
      logger.info(
        '✅ Call 1 completed in $call1Time ms',
        category: LogCategory.audio,
      );
      logger.info(
      ...
      logger.info(
        '✅ Call 2 completed in $call2Time ms',
        category: LogCategory.audio,
      );
      logger.info(
        'Call 1 time: $call1Time ms, Call 2 time: $call2Time ms',
        category: LogCategory.audio,
      );
      logger.info(
