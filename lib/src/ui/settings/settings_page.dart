                ...
                child: Column(
                  children: [
                    ...
                    SwitchListTile(
                      ...
                      title: const Text('Show Audio Player'),
                      subtitle: const Text('Display playback controls in reader'),
                      value: _viewModel.showAudioPlayer,
                      onChanged: _viewModel.setShowAudioPlayer,
                    ),
                  ],
                ),
              ),
